			...
			try {
				...
				if (SiebelApp.S_App.IsMobileApplication() !== "true") {
					...
					if (!(aV.hasClass("addshowactivated"))) {
						...
						aY = '<a href="#" id="sidebarOpenButton" title="Open Sidebar" class="sidebarNavButton hidden">' + (aT ? "&laquo;" : "&raquo;") + "</a>",
						aZ = $("#_swecontent"),
						...
						aY = '<a href="#" class="sidebarNavButton" id="sidebarCloseButton" title="Close Sidebar">' + (aT ? "&raquo;" : "&laquo;") + "</a>";
						aQ.prepend(aY);
