...
//      if( !data.key ){
	...
	_getInnerHtml: function() {
		var tree = this.tree,
			...
			var data_key_del = data_key.replace(/\s+/g, '');
			if (data_key_del === "SmartScriptPlayerScreen(eApps)") {
					var data_key_del = data_key_del.replace("SmartScriptPlayerScreen(eApps)","SmartScriptPlayerScreen");
			}
			if (data_key_del === "ATCApplicationInfoAboutTP/GoodsView") {
					var data_key_del = data_key_del.replace("ATCApplicationInfoAboutTP/GoodsView","ATCApplicationInfoAboutTPGoodsView");
			}
...
//          noop(); // keep JSLint happy
		...
		if(!nodeTitle){
			...
			if( opts.noLink || data.noLink ) {
				nodeTitle = '<span style="display:inline-block;" class="' + opts.classNames.title + '"' + tooltip + '' + triangle + '>' + data.title + '</span>';
//              this.tree.logDebug("nodeTitle: " + nodeTitle);
			} else {
				nodeTitle = '<a href="' + href + '" class="' + opts.classNames.title + '"' + tooltip + '><span class="' + data_key_del + ' dynatree-title"></span>' + data.title + '</a>';
